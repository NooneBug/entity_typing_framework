from entity_typing_framework.EntityTypingNetwork_classes.base_network import BaseEntityTypingNetwork, EntityTypingNetworkForIncrementalTraining, BoxEmbeddingEntityTypingNetwork
...
from entity_typing_framework.main_module.losses import BCELossForET, BoxEmbeddingBCELoss
...
IMPLEMENTED_CLASSES_LVL0 = {
    ...
    'BoxEmbeddingBCELoss' : BoxEmbeddingBCELoss,
    ...
    'BoxEmbeddingEntityTypingNetwork': BoxEmbeddingEntityTypingNetwork,
    }
