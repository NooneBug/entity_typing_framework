...
class KENNDataset(BaseDataset):
    ...
    def __init__(self, name, dataset_paths, types_file_path, clause_output_path = None, learnable_clause_weight = False, clause_weight = .5, kb_mode = 'top_down'):
    ...
    def automatic_build_clauses(self, types_file_path, clause_output_path = None, learnable_clause_weight = False, clause_weight = 0.5, kb_mode = 'top_down'):
        ### CREATE KB ###
        # get ontology tree
